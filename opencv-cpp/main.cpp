...
Mat HoughCircle(Mat gray_img, Mat midd_img) {
    ...
    HoughCircles(gray_img, circles, HOUGH_GRADIENT, 1, 20, 100, 50, int(gray_img.size[0] * 0.35), int(gray_img.size[0] * 0.48));
...
Mat HoughLine(Mat midd_img, Mat midd_line_img) {
    ...
    HoughLinesP(midd_line_img, mylines, 3, 3.14/180, 100, 10,0 );
